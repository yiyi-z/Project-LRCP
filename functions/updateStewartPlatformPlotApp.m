function updateStewartPlatformPlotApp(uiAxis, transformed_t, pArray, bArray, betaArray, servoAngleArray, a, baseToTop, topToTarget, t, housingUnitVectors)
    ...
    line(uiAxis,[x(3), x(4)], [y(3), y(4)], [z(3), z(4)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(4), x(5)], [y(4), y(5)], [z(4), z(5)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(5), x(6)], [y(5), y(6)], [z(5), z(6)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(6), x(7)], [y(6), y(7)], [z(6), z(7)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(7), x(8)], [y(7), y(8)], [z(7), z(8)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(8), x(3)], [y(8), y(3)], [z(8), z(3)], 'Color', 'b', 'LineStyle', '-'); 

    line(uiAxis,[x(9), x(10)], [y(9), y(10)], [z(9), z(10)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(10), x(11)], [y(10), y(11)], [z(10), z(11)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(11), x(12)], [y(11), y(12)], [z(11), z(12)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(12), x(13)], [y(12), y(13)], [z(12), z(13)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(13), x(14)], [y(13), y(14)], [z(13), z(14)], 'Color', 'b', 'LineStyle', '-'); 
    line(uiAxis,[x(14), x(9)], [y(14), y(9)], [z(14), z(9)], 'Color', 'b', 'LineStyle', '-'); 

    line(uiAxis,[x(9), x(15)], [y(9), y(15)], [z(9), z(15)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(10), x(16)], [y(10), y(16)], [z(10), z(16)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(11), x(17)], [y(11), y(17)], [z(11), z(17)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(12), x(18)], [y(12), y(18)], [z(12), z(18)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(13), x(19)], [y(13), y(19)], [z(13), z(19)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(14), x(20)], [y(14), y(20)], [z(14), z(20)], 'Color', 'r', 'LineStyle', '-');

    line(uiAxis,[x(3), x(15)], [y(3), y(15)], [z(3), z(15)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(4), x(16)], [y(4), y(16)], [z(4), z(16)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(5), x(17)], [y(5), y(17)], [z(5), z(17)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(6), x(18)], [y(6), y(18)], [z(6), z(18)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(7), x(19)], [y(7), y(19)], [z(7), z(19)], 'Color', 'r', 'LineStyle', '-'); 
    line(uiAxis,[x(8), x(20)], [y(8), y(20)], [z(8), z(20)], 'Color', 'r', 'LineStyle', '-');
